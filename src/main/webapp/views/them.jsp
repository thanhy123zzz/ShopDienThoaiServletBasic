...
<body>
	...
	<div class="container">
		<h2>Thêm sản phẩm</h2>
		<form class="form-horizontal" action="/ShopDienThoai/trang-chu/them"
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<input type="text" name="name" class="form-control" id="name"
						...
						value="<c:out value="${dienThoai.name}"></c:out>">
				</div>
			</div>
			<div class="form-group">
				<label class="control-label col-sm-2" for="pwd">Thông tin
					chi tiết:</label>
				<div class="col-sm-10">
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<input type="text" class="form-control" placeholder="Nhập số lượng"
						name="soluong" value="${dienThoai.soluong}">
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-sm-10">
					<input type="file" class="form-control" name="image"
						accept=".png,.jpg,.jpeg"> <br> <img
						src="data:image/jpg;base64,${dienThoai.image}" width="300"
						height="240">
				</div>
